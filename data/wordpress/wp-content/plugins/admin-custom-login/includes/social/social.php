...
<div class="row">
					...
					<div class="post-social post-social-xs" id="post-social-5">
						<div class="text-center padding-all text-center">
							<div class="textbox text-white   margin-bottom settings-title">
								<?php esc_html_e('Social Settings','admin-custom-login')?>
							</div>
						</div>
					</div>
				</div>
				...
				<tr class="radio-span" style="border-bottom:none;">
					<td>
						<select id="enable_social_icon" class="standard-dropdown" name="enable_social_icon">
							...
							<option value="inner" ><?php esc_html_e('Inner','admin-custom-login')?></option>
							<option value="outer" ><?php esc_html_e('Outer','admin-custom-login')?></option>
							<option value="both" ><?php esc_html_e('Both','admin-custom-login')?></option>
						</select>
					</td>
				</tr>
			</table>
			...
			<table class="form-table">
				...
				<tr class="radio-span" style="border-bottom:none;">
					<td>
						...
						<span>
							<input type="radio" name="social_size" value="mediam" id="social_size2" <?php if($social_icon_size=="mediam")echo esc_attr("checked"); ?> />&nbsp;<label for="social_size2"><?php esc_html_e('Medium','admin-custom-login')?></label><br>
						</span>
						<span>
							<input type="radio" name="social_size" value="large" id="social_size3"  <?php if($social_icon_size=="large")echo esc_attr("checked"); ?> />&nbsp;<label for="social_size3"><?php esc_html_e('Large','admin-custom-login')?></label><br>
						</span>
					</td>
				</tr>
			</table>
			...
			<table class="form-table">
				...
				<tr class="radio-span" style="border-bottom:none;">
					<td>
						...
						<span>
							<input type="radio" name="social_layout" value="circle" id="social_layout2" <?php if($social_icon_layout=="circle")echo esc_attr("checked"); ?>  />&nbsp;<label for="social_layout2"><?php esc_html_e('Circle','admin-custom-login')?></label><br>
						</span>
					</td>
				</tr>
			</table>
	...
	<div class="panel panel-primary panel-default content-panel">
		<div class="panel-body">
			<table class="form-table">
				<tr>
					<th scope="row" ><?php esc_html_e('Enable To Open Social Link In New Window', 'admin-custom-login')?></th>
					<td></td>
				</tr>
				...
				<tr class="radio-span" style="border-bottom:none;">
					<td>
						<?php 
		                    ...
		                    ?>
						<span>
							<input type="radio" name="social_link_new_window" value="yes" id="social_link_new_window1" <?php if($social_link_new_window=="yes")echo esc_attr("checked"); ?> <?php if(empty($social_link_new_window))echo esc_attr("checked"); ?> />&nbsp;<label for="social_link_new_window1"><?php esc_html_e('Yes', 'admin-custom-login')?></label><br>
						</span>
						<span>
							<input type="radio" name="social_link_new_window" value="no" id="social_link_new_window2" <?php if($social_link_new_window=="no")echo esc_attr("checked"); ?> />&nbsp;<label for="social_link_new_window2"><?php esc_html_e('No', 'admin-custom-login')?></label><br>
						</span>
					</td>
				</tr>
			</table>
				...
				<tr class="radio-span" style="border-bottom:none;">
					<td>
						...
						<ul class="rcp_social_profile_admin">
							<li><i class="fab fa-facebook-f"></i><input type="text" class="pro_text" id="facebook-link" name="facebook-link" placeholder="<?php esc_attr_e('Facebook', 'admin-custom-login')?>" size="56" value="<?php echo esc_attr($social_facebook_link); ?>" /></li>
							<li><i class="fab fa-twitter"></i><input type="text" class="pro_text" id="twitter-link" name="twitter-link" placeholder="<?php esc_attr_e('Twitter', 'admin-custom-login')?>" size="56" value="<?php echo esc_attr($social_twitter_link); ?>" /></li>
							<li><i class="fab fa-linkedin-in"></i><input type="text" class="pro_text" id="linkedin-link" name="linkedin-link" placeholder="<?php esc_attr_e('Linkedin', 'admin-custom-login'); ?>" size="56" value="<?php echo esc_attr($social_linkedin_link); ?>" /></li>
							<li><i class="fab fa-pinterest-p"></i><input type="text" class="pro_text" id="pinterest-link" name="pinterest-link" placeholder="<?php esc_attr_e('Pinterest', 'admin-custom-login'); ?>" size="56" value="<?php echo esc_attr($social_pinterest_link); ?>" /></li>
							<li><i class="fab fa-digg"></i><input type="text" class="pro_text" id="digg-link" name="digg-link" placeholder="<?php esc_attr_e('Digg', 'admin-custom-login')?>" size="56" value="<?php echo esc_attr($social_digg_link); ?>" /></li>
							<li><i class="fab fa-youtube-square"></i><input type="text" class="pro_text" id="youtube-link" name="youtube-link" placeholder="<?php esc_attr_e('Youtube', 'admin-custom-login')?>" size="56" value="<?php echo esc_attr($social_youtube_link); ?>" /></li>
							<li><i class="fab fa-flickr"></i><input type="text" class="pro_text" id="flickr-link" name="flickr-link" placeholder="<?php esc_attr_e('Flickr', 'admin-custom-login')?>" size="56" value="<?php echo esc_attr($social_flickr_link); ?>" /></li>
							<li><i class="fab fa-tumblr"></i><input type="text" class="pro_text" id="tumblr-link" name="tumblr-link" placeholder="<?php esc_attr_e('Tumblr', 'admin-custom-login')?>" size="56" value="<?php echo esc_attr($social_tumblr_link); ?>" /></li>
							<li><i class="fab fa-skype"></i><input type="text" class="pro_text" id="skype-link" name="skype-link" placeholder="<?php esc_attr_e('Skype', 'admin-custom-login')?>" size="56" value="<?php echo esc_attr($social_skype_link); ?>" /></li> 
							<li><i class="fab fa-instagram"></i><input type="text" class="pro_text" id="instagram-link" name="instagram-link" placeholder="<?php esc_attr_e('Instagram', 'admin-custom-login')?>" size="56" value="<?php echo esc_attr($social_instagram_link); ?>" /></li>
							<li><i class="fab fa-telegram-plane"></i><input type="text" class="pro_text" id="telegram-link" name="telegram-link" placeholder="<?php esc_attr_e('Telegram', 'admin-custom-login')?>" size="56" value="<?php echo esc_attr($social_telegram_link); ?>" /></li>
							<li><i class="fab fa-whatsapp"></i><input type="text" class="pro_text" id="whatsapp-link" name="whatsapp-link" placeholder="<?php esc_attr_e('Whatsapp', 'admin-custom-login')?>" size="56" value="<?php echo esc_attr($social_whatsapp_link); ?>" /></li>
						</ul>
					</td>
				</tr>
			</table>
	...
	<div id="somedialog5" class="dialog" style="position: fixed; z-index: 9999;">
		...
		<div class="dialog__content">
			...
			<div class="dialog-inner">
				<h2><strong><?php esc_html_e('Social', 'admin-custom-login')?></strong> <?php esc_html_e('Setting Save Successfully','admin-custom-login')?></h2><div><button class="action dialog-button-close" data-dialog-close id="dialog-close-button5"><?php esc_html_e('Close','admin-custom-login')?></button></div>
			</div>
		</div>
	</div>
	...
	<div id="somedialog6" class="dialog" style="position: fixed; z-index: 9999;">
		...
		<div class="dialog__content">
			...
			<div class="dialog-inner">
				<h2><strong><?php esc_html_e('Social','admin-custom-login')?></strong> <?php esc_html_e('Setting Reset Successfully','admin-custom-login')?></h2><div><button class="action dialog-button-close" data-dialog-close id="dialog-close-button6"><?php esc_html_e('Close','admin-custom-login')?></button></div>
			</div>
		</div>
	</div>
