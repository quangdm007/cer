...
global $product;
$browse_wishlist_text = strpos( $browse_wishlist_text, '</i>' ) == false ? $browse_wishlist_text : '<i class="fas fa-check"></i>';
?>
...
<div class="yith-wcwl-wishlistaddedbrowse">
    ...
    <a href="<?php echo esc_url( $wishlist_url ) ?>" rel="nofollow"
       data-title="<?php echo esc_attr( $browse_wishlist_text ) ?>">
		<?php echo ( ! $is_single && 'before_image' == $loop_position ) ? esc_html( $icon ) : false ?>
