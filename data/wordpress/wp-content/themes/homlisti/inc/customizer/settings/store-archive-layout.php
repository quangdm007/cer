	...
	public function register_store_archive_layout_controls( $wp_customize ) {
		...
		$wp_customize->add_control( new Customizer_Image_Radio_Control( $wp_customize, 'store_archive_layout',
			[
				...
				'description' => esc_html__( 'Select the default template layout for store archive', 'homlisti' ),
		...
		//Menu Alignment
		$wp_customize->add_setting( 'store_archive_menu_alignment', [
			'capability'        => 'edit_theme_options',
			'sanitize_callback' => 'rttheme_text_sanitization',
			'default'           => $this->defaults['menu_alignment'],
		] );

		$wp_customize->add_control( 'store_archive_menu_alignment', [
			'type'    => 'select',
		...
		$wp_customize->add_control( 'store_archive_padding_top',
			[
				...
				'description' => esc_html__( 'Store Archive Content Padding Top ', 'homlisti' ),
				'section'     => 'store_archive_layout_section',
				'type'        => 'text',
			]
		);
		...
		$wp_customize->add_control( 'store_archive_padding_bottom',
			[
				...
				'description' => esc_html__( 'Store Archive Content Padding Bottom', 'homlisti' ),
				'section'     => 'store_archive_layout_section',
				'type'        => 'text',
			]
		);
