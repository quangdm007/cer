    ...
    <div class="container rtcl-widget-border-enable rtcl-widget-is-sticky mb-5">
        <div class="rtcl-main-content-wrapper">
            ...
            <div class="rtcl-content-wrapper">
				...
				echo !RDTheme::$options['listing_detail_sidebar'] ? '<div class="row"><div class="col-lg-10 offset-lg-1 col-md-12">' : NULL;
                Helper::get_custom_listing_template( 'listing-heading' );
				echo !RDTheme::$options['listing_detail_sidebar'] ? '</div></div>' : NULL;
                ?>
                <!--End Listing Heading-->
