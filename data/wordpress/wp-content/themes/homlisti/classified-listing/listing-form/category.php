...
<div class="rtcl-listing-info-selecting homlisti-listing-form">
	<?php if ( ! Functions::is_ad_type_disabled() ): ?>
        <div id="rtcl-ad-type-selection">
            <div class="rtcl-post-section-title">
                <h3>
                    <i class="rtcl-icon rtcl-icon-tags"></i><?php esc_html_e( "Select a type", "homlisti" ); ?>
                </h3>
            </div>
            <div class="form-group row">
                <label for="rtcl-category"
                       class="col-md-2 col-form-label"><?php esc_html_e( 'Ad Type', 'homlisti' ); ?>
                    <span class="require-star">*</span>
                </label>
                <div class="col-md-10">
                    <select class="rtcl-select2 form-control" id="rtcl-ad-type" name="type" required>
                        <option value=""><?php esc_html_e( "--Select a type--", "homlisti" ) ?></option>
						<?php
    ...
    <div id="rtcl-ad-category-selection"
         style="display: <?php echo esc_attr( ( ( $selected_type && in_array( $selected_type, array_keys( Functions::get_listing_types() ) ) ) || Functions::is_ad_type_disabled() )
		     ? 'block' : 'none' ); ?>">
        <div class="rtcl-post-section-title">
            <h3>
                <i class="rtcl-icon rtcl-icon-tags"></i><?php esc_html_e( "Select a category", "homlisti" ); ?>
            </h3>
        </div>
        <div class="rtcl-post-category">
            <div class="form-group row" id="cat-row">
                <label for="rtcl-category"
                       class="col-md-2 col-form-label"><?php esc_html_e( 'Category', 'homlisti' ); ?>
            ...
            <div class="form-group row<?php echo empty( $child_cats ) ? ' rtcl-hide' : ''; ?>" id="sub-cat-row">
                <label for="rtcl-sub-category"
                       class="col-md-2 col-form-label"><?php esc_html_e( 'Sub Category', 'homlisti' ); ?>
                    <span class="require-star">*</span></label>
